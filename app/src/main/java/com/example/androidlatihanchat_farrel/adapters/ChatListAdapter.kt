...
import com.example.androidlatihanchat_farrel.widgets.CircleTransform
...
class ChatListAdapter(private val mContext: Context, items: ArrayList<ChatMessage>) :
    ...
    override fun onBindViewHolder(holder: ChatListAdapter.ViewHolder, position: Int) {
        ...
        if (c.sender.id == set.readSetting("myid")) {
            ...
            Picasso.with(mContext).load(c.receiver.photo).resize(100, 100).transform(CircleTransform())
                .into(holder.image)
